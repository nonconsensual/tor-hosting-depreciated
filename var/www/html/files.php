...
function send_login(){
	echo '<!DOCTYPE html><html><head>';
	echo '<title>Wowmee\'s Hosting - FileManager - Login</title>';
	echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">';
	echo '<meta name=viewport content="width=device-width, initial-scale=1">';
	echo '</head><body>';
...
function send_rename($dir){
	echo '<!DOCTYPE html><html><head>';
	echo '<title>Wowmee\'s Hosting - FileManager - Rename file</title>';
	echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">';
	echo '<meta name=viewport content="width=device-width, initial-scale=1">';
	echo '</head><body>';
...
function send_edit($ftp, $dir){
	echo '<!DOCTYPE html><html><head>';
	echo '<title>Wowmee\'s Hosting - FileManager - Edit file</title>';
	echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8">';
	echo '<meta name=viewport content="width=device-width, initial-scale=1">';
	echo '</head><body>';
	echo '<form action="files.php" method="post">';
